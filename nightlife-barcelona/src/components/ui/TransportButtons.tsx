  ...
  return (
    <div className="mt-6">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <a href="https://cabify.com/es" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center gap-1.5 rounded-2xl border py-4 text-xs font-bold text-white transition hover:scale-[1.02]" style={{ background: "rgba(124,58,237,0.2)", borderColor: "rgba(124,58,237,0.4)" }}>
          <span className="text-2xl">🟣</span>
          Cabify
        </a>
        <a href="https://free-now.com" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center gap-1.5 rounded-2xl border py-4 text-xs font-bold text-white transition hover:scale-[1.02]" style={{ background: "rgba(202,138,4,0.2)", borderColor: "rgba(202,138,4,0.4)" }}>
          <span className="text-2xl">🚕</span>
          FREE NOW
        </a>
      </div>
