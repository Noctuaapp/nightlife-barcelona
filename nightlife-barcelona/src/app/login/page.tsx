  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-black px-4 text-white">
      <div className="w-full max-w-md rounded-[32px] border border-white/10 bg-white/[0.04] p-8">
        ...
        <p className="mt-3 text-zinc-400">Save favorites, manage your nights and access your account.</p>
        ...
        <Link href="/signup" className="mt-5 block text-center text-sm font-bold text-zinc-400 hover:text-white">
          New to Noctua? Create account
        </Link>
      </div>
    </main>
  )
